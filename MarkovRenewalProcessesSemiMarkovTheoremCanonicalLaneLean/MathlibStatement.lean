...
import MarkovRenewalProcessesSemiMarkovTheoremCanonicalLaneLean.FinalTheorem
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedSemiMarkovClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_semi_markov_endgame A
